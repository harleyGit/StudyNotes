...
- **plist文件存取**
- **JSON文件存储**
- [**NSUserDefaults文件的查看**](https://blog.csdn.net/monkey_cool/article/details/40891967)
- [**PropertyList (属性列表) 、NSUserDefaults (偏好设置) 、NSKeyedArchiver (归档)**](https://www.jianshu.com/p/785028f0e193)
