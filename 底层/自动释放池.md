...
![z37](https://raw.githubusercontent.com/harleyGit/StudyNotes/master/Pictures/z37.png)
...
![z36](https://raw.githubusercontent.com/harleyGit/StudyNotes/master/Pictures/z36.png)
...
<br/>
	...
	SDWebimage中返回带有帧数组的动画图像的`+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<SDImageFrame *> * _Nullable)frames;
`方法的代码片段
