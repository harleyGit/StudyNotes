...
<br/>
## 官方解释UIScrollView
&emsp;   首先还是看官方API如何解释UIScrollView，一下是翻译官方UIScrollView的帮助文档。
...
&emsp;  重要的提示：在UIScrollView对象中，你`不应该嵌入任何UIWebView和UITableView`。假如这样做，会出现一些异常情况，因为2个对象的触摸事件可能被混合，从而错误的处理。
