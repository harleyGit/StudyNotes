> <h2 id=''></h2>
- [**知识预备**](#知识预备)
	- [Creat groups和Create folder references区别](#Creatgroups和Createfolderreferences区别)
	- [代码分发方式](#代码分发方式)
	- [各个语言编译流程](#各个语言编译流程)
- [**语言编译流程**](#语言编译流程)
...
> <h2 id='Creatgroups和Createfolderreferences区别'>Creat groups和Create folder references区别</h2>
