...
![使用静态库](https://raw.githubusercontent.com/harleyGit/StudyNotes/master/Pictures/ios_oc41.png)

&emsp; 这个库是模拟器的,在真机中是没法使用的.
...
&emsp; 之后，让Xcode进行Build，之后在对应的Build文件夹下的Products文件夹中可以找到生成的framework文件.
