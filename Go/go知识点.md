...
- [**数据库**](#数据库)
	- [**SQL数据库**](#SQL数据库)
		...
		- [**事务**](#事务)
			- [大致说下事务中出现的脏写、脏读、不可重复读、幻读](#大致说下事务中出现的脏写、脏读、不可重复读、幻读)
...
># <h2 id="哪些情况适合创建索引">[哪些情况适合创建索引](./数据库SQL(VI).md#哪些情况适合创建索引)</h2>
...
># <h2 id="哪些情况不适合创建索引">[哪些情况不适合创建索引](./数据库SQL(VI).md##哪些情况不适合创建索引)</h2>
...
> <h2 id="大致说下事务中出现的脏写、脏读、不可重复读、幻读">大致说下事务中出现的脏写、脏读、不可重复读、幻读</h2>
